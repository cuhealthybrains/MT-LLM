    ...
    for sample in progress:
        ...
        for i, sample_id in enumerate(sample["id"].tolist()):
            ...
            if not cfg.common_eval.quiet:
                ...
                if has_target:
                    print("TARG-{}\t{}".format(sample_id, target_str), file=output_file)
                    print("TARG-{}\t{}".format(sample_id, target_str))
            ...
            for j, hypo in enumerate(hypos[i][: cfg.generation.nbest]):
                ...
                if not cfg.common_eval.quiet:
                    ...
                    print(
                        "PRED-{}\t{}".format(sample_id, hypo_str),
                    )

                    print(
                        "PRED-{}\t{}\t{}".format(sample_id, score, repr(hypo_str)),
                        file=output_file,
                    )
