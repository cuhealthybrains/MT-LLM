...
class SequenceGenerator(nn.Module):
    ...
    def _generate(
        ...
        with torch.autograd.profiler.record_function("EnsembleModel: forward_encoder"):
            ...
            encoder_outs, _ = zip(*all_encoder_outs)
    ...
    def forward_decoder(
        ...
        for i, model in enumerate(self.models):
            ...
            if self.has_incremental_states():
                ...
                # TODO
                # encoder_out = None
                decoder_out = model.gpt_model.forward_generate(tokens, start_pos, encoder_out, left_prompts=left_prompts, incremental_state=incremental_states[i])
            else:
